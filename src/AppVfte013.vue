...
<template>
  ...
  <div class="pt-page pt-page-current pt-page-controller search-pager">
    <PageHeader ref="pageHeader" :labels="labels" pid="vfte013" version="1.0.0" showLanguage="true" @language-changed="changeLanguage" :multiLanguages="multiLanguages" :build="buildVersion" :visible="displayPageHeader" />
    ...
    this.$nextTick(async () => {
      ...
      startApplication("vfte013",(data) => {
        ...
        if(data.type=="language") {
          ...
          loadAndMergeLabel("vfte013", (success) => {
            if (success) {
